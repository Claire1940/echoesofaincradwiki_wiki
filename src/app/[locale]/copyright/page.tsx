...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Echoes of Aincrad Wiki',
    description: 'Copyright and intellectual property information for Echoes of Aincrad Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Echoes of Aincrad Wiki',
      description: 'Copyright and intellectual property information for Echoes of Aincrad Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Echoes of Aincrad Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Echoes of Aincrad Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Echoes of Aincrad Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Echoes of Aincrad Developers</strong> - Creators of the Echoes of Aincrad game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Echoes of Aincrad</strong> - Trademark of the game developers</li>
              <li><strong>Echoes of Aincrad Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Echoes of Aincrad Wiki.
            </p>
            ...
            <p>
              ...
              Echoes of Aincrad Wiki<br />
              Email: <a href="mailto:dmca@echoesofaincradwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@echoesofaincradwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Echoes of Aincrad Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Echoes of Aincrad Wiki (echoesofaincradwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@echoesofaincradwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@echoesofaincradwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@echoesofaincradwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@echoesofaincradwiki.wiki</a>
            </p>
            <p>
